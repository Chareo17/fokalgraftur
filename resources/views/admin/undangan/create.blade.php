        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="text-center mb-4">
                    ...
                    <h1 class="display-6 fw-bold text-white mb-2">Buat Undangan Baru</h1>
                    <p class="text-white-50 mb-0">Buat undangan event untuk alumni dan siswa</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-xl" style="background: rgba(255,255,255,0.95); backdrop-filter: blur(20px); border-radius: 24px;">
                    <div class="card-body p-5">
                        <form action="{{ route('admin.undangan.store') }}" method="POST" enctype="multipart/form-data" id="undanganForm">
                            @csrf
                            ...
                            <!-- Name Field -->
                            <div class="mb-4">
                                <label for="name" class="form-label fw-semibold text-dark mb-3">
                                    <i class="bi bi-person me-2"></i>Nama Pengirim
                                </label>
                                <div class="input-group input-group-lg">
                                    <span class="input-group-text border-0" style="background: linear-gradient(45deg, #667eea, #764ba2); color: white;">
                            ...
                            <div class="mb-4">
                                <label for="gambar" class="form-label fw-semibold text-dark mb-3">
                                    <i class="bi bi-image me-2"></i>Gambar Undangan (Opsional)
                                </label>
                                <div class="input-group">
                                    <span class="input-group-text border-0" style="background: linear-gradient(45deg, #667eea, #764ba2); color: white;">
                                ...
                                <div class="form-text text-muted mt-2">
                                    <i class="bi bi-info-circle me-1"></i>Format yang didukung: JPG, PNG, PDF. Maksimal 10MB.
                                </div>
                            </div>

                            <!-- Gambar Barcode Tanda Tangan Field -->
                            <div class="mb-4">
                                <label for="gambar_barcode_tanda_tangan" class="form-label fw-semibold text-dark mb-3">
                                    <i class="bi bi-upc-scan me-2"></i>Gambar Barcode Tanda Tangan (Opsional)
                                </label>
                                <div class="input-group">
                                    <span class="input-group-text border-0" style="background: linear-gradient(45deg, #667eea, #764ba2); color: white;">
                                    ...
                                    <input type="file"
                                           class="form-control border-0 shadow-sm @error('gambar_barcode_tanda_tangan') is-invalid @enderror"
                                           id="gambar_barcode_tanda_tangan"
                                           name="gambar_barcode_tanda_tangan"
                                           accept="image/*"
                                           style="background: #f8fafc; border-radius: 0 12px 12px 0;">
                                    @error('gambar_barcode_tanda_tangan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-text text-muted mt-2">
                                    <i class="bi bi-info-circle me-1"></i>Format yang didukung: JPG, PNG, GIF. Maksimal 10MB.
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-check-lg">
                                            <input class="form-check-input @error('role_target') is-invalid @enderror"
                                                   ...
                                                   name="role_target[]"
                                                   value="alumni"
                                                   {{ in_array('alumni', old('role_target', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-check-lg">
                                            <input class="form-check-input @error('role_target') is-invalid @enderror"
                                                   ...
                                                   name="role_target[]"
                                                   value="siswa"
                                                   {{ in_array('siswa', old('role_target', [])) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex justify-content-between align-items-center pt-4 border-top">
                                ...
                                <button type="submit" class="btn btn-primary rounded-pill px-5 py-2 fw-semibold" style="background: linear-gradient(45deg, #4F46E5, #7C3AED); border: none;">
                                    <i class="bi bi-send me-2"></i>Buat Undangan
                                </button>
                            </div>
                        </form>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fileInput.addEventListener('change', function (e) {
        ...
        if (file) {
            ...
            const fileSize = (file.size / 10024 / 10024).toFixed(10); // MB
